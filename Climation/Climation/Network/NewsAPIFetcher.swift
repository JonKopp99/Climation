...
class NewsAPIFetcher
{
    ...
    func getArticles()
    {
        let urlRequest = URLRequest(url: URL(string: "https://newsapi.org/v2/everything?q=climate_change&from=2019-08-00&to=2019-09-3&language=en&sortBy=popularity&apiKey=2f14afa396d145efb9525f59e93c9c57")!)
